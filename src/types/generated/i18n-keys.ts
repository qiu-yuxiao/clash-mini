...
export const translationKeys = [
  ...
  'settings.mini.routingPreference',
  'settings.mini.direct',
  'settings.mini.rules',
  'settings.mini.proxy',
  'settings.mini.routingTooltipDirect',
  'settings.mini.routingTooltipRules',
  'settings.mini.routingTooltipProxy',
