...
export const translationKeys = [
  ...
  'layout.a11y.pinWindow',
  'layout.a11y.openSettings',
  'layout.a11y.closeSettings',
  'layout.a11y.closeLogsDialog',
  'layout.a11y.selectLanguage',
  'logs.page.title',
  ...
  'settings.mini.profilesTitle',
  'settings.mini.importConfig',
  'settings.mini.importPlaceholder',
  'settings.mini.unnamedConfig',
  'settings.mini.nodeCount',
  'settings.mini.localFile',
  'settings.mini.takeoverMode',
  'settings.mini.manual',
  'settings.mini.system',
  'settings.mini.tun',
  'settings.mini.takeoverTooltipManual',
  'settings.mini.takeoverTooltipSystem',
  'settings.mini.takeoverTooltipTun',
  'settings.mini.debugLogs',
  'settings.mini.pathControl',
  'settings.mini.statusTesting',
  'settings.mini.statusUntested',
  'settings.mini.statusError',
  'settings.mini.statusTimeout',
  'settings.mini.statusDelayHigh',
  'settings.mini.statusDelayMedium',
  'settings.mini.statusDelayGood',
  'settings.mini.statusDelayExcellent',
  'settings.mini.activeNodeLabel',
  'settings.mini.connectionsActive',
  'settings.mini.connectionsHistory',
  'settings.mini.connectionsDisconnectAll',
  'settings.mini.connectionsClearHistory',
  'settings.mini.total',
  'settings.mini.proxyMethod',
  'settings.mini.globalProxy',
  'settings.mini.gfwlist',
  'settings.mini.addUrl',
  'settings.mini.globalProxyTooltip',
  'settings.mini.gfwlistTooltip',
  'settings.mini.addUrlTooltip',
  'settings.mini.addUrlPlaceholder',
  'settings.mini.addUrlButton',
  'settings.mini.addUrlSuccess',
  'settings.mini.addUrlNoChange',
  ...
  'shared.filters.logLevels.label',
