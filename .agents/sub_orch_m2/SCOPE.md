...
| 2.2 | Profile Saves Optimization | Optimize `save_file` in `prfitem.rs` and `save_profile_file` in `save_profile.rs` to read and compare file content before writing. | None | PLANNED |
